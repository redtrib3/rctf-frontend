<template>
        ...
        <div class="max-w-lg p-6 bg-gray-800 border  rounded-lg mx-4 my-4 shadow border-gray-700 hover:scale-95 transform transition duration-300 relative">
            <a>
                ...
                <span class="flex">
                    <h5 :class="{'text-2xl font-bold tracking-tight font-mono': true, 'text-green-500':solvedChalls.includes(challJson.id), 'text-white': !solvedChalls.includes(challJson.id) }">{{ challJson.title }}</h5>
